...
Perbug Core connects to the Perbug peer-to-peer network to download and fully
validate blocks and transactions. It also includes a wallet and graphical user
interface, which can be optionally built.

Further information about Perbug Core is available in the [doc folder](/doc).
...
completely stable. [Tags](https://github.com/perbugcore/perbug/tags) are created
...
[Perbug Core's Transifex page](https://explore.transifex.com/perbug/perbug/).
