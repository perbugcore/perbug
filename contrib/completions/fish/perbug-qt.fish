...
complete --command perbug-qt --no-files

# Extract options
function __fish_perbugqt_get_options
...
complete \
    --command perbug-qt \
    --arguments "(__fish_perbugqt_get_options --nofiles)"
