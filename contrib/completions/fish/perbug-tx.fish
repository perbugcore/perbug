...
# Extract options
function __fish_perbug_tx_get_options
...
# Extract commands
function __fish_perbug_tx_get_commands
...
complete \
    --command perbug-tx \
    --condition "not __fish_perbug_seen_cmd (__fish_perbug_tx_get_commands --commandsonly)" \
    --arguments "(__fish_perbug_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command perbug-tx \
    --arguments "(__fish_perbug_tx_get_commands)" \
    --no-files
