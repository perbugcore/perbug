...
complete --command perbugd --no-files

# Extract options
function __fish_perbugd_get_options
...
complete \
    --command perbugd \
    --arguments "(__fish_perbugd_get_options --nofiles)"
