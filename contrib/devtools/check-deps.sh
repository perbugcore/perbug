...
declare -A LIBS
LIBS[cli]="libperbug_cli.a"
LIBS[common]="libperbug_common.a"
LIBS[consensus]="libperbug_consensus.a"
LIBS[crypto]="libperbug_crypto.a"
LIBS[node]="libperbug_node.a"
LIBS[util]="libperbug_util.a"
LIBS[wallet]="libperbug_wallet.a"
...
# https://github.com/perbug/perbug/issues/10102
