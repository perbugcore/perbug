...
BITCOIND=${BITCOIND:-$BINDIR/perbugd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/perbug.conf}
...
then
  ...
  echo -e "To safely generate a perbug.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example perbug.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-perbug-conf.sh.
##
...
# parse the output from perbugd --help
