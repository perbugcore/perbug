...
(define* (make-perbug-cross-toolchain target
                                       #:key
...
desirable for building Perbug Core release binaries."
...
;; failure; see https://github.com/perbug/perbug/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-perbug-cross-toolchain target)))
