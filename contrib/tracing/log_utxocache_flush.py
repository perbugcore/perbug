...
"""Example logging Perbug Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/perbugd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[perbugd_with_usdts])
