#!/usr/bin/env python3
# Copyright (c) 2021 The Perbug Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

""" Interactive perbugd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Perbug Core can enable. It uses BCC
...
def main(pid):
    ...
    perbugd_with_usdts.enable_probe(
