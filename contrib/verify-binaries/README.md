...
As of Perbug Core v22.0, releases are signed by a number of public keys on the basis
of the [guix.sigs repository](https://github.com/perbug-core/guix.sigs/). When
...
builder-keys](https://github.com/perbug-core/guix.sigs/tree/main/builder-keys) and
...
signature file `SHA256SUMS.asc` from https://perbugcore.org and https://perbug.org.
...
./contrib/verify-binaries/verify.py bin ~/Downloads/SHA256SUMS \
    ~/Downloads/perbug-24.0.1-x86_64-linux-gnu.tar.gz \
    ~/Downloads/perbug-24.0.1-arm-linux-gnueabihf.tar.gz
```
