...
Perbug Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Perbug Core

**When configuring Perbug Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Perbug Core:
...
variables will be set when generating the Perbug Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
