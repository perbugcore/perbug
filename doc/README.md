...
To download Perbug Core, visit [perbugcore.org](https://perbugcore.org/en/download/).

Running
---------------------
The following are some helpful notes on how to run Perbug Core on your native platform.
...
Building
---------------------
The following are developer notes on how to build Perbug Core on your native platform. They are not complete guides, but include notes on the necessary libraries, compile flags, etc.
...
- [Source Code Documentation (External Link)](https://doxygen.perbugcore.org/)
