...
Assumeutxo is a feature that allows fast bootstrapping of a validating perbugd
instance.
...
```
$ perbug-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ perbug-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
