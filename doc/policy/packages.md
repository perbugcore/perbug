...
* Only limited package replacements are currently considered. (#28984)
   ...
   - Must improve [feerate diagram](https://delvingperbug.org/t/mempool-incentive-compatibility/553). (#29242)
...
[TRUC transactions](https://github.com/perbug/bips/blob/master/bip-0431.mediawiki) as an individual
