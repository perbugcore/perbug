...
```sh
cmake --build build --target perbugd perbug-cli
cmake --build build --target perbug-qt
cmake --build build --target bench_perbug
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:perbug/perbug.git
```
...
> e.g. github.com/perbug/perbug.git or for the GUI github.com/perbug-core/gui
