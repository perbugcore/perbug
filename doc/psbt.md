# PSBT Howto for Perbug Core

Since Perbug Core 0.17, an RPC interface exists for Partially Signed Perbug
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/perbug/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Perbug transactions that are not fully signed
...
#### Multisig with multiple Perbug Core instances
