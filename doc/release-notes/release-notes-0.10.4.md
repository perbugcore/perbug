Perbug Core version 0.10.4 is now available from:

  <https://perbug.org/bin/perbug-core-0.10.4/>
...
- #6953 `43c2789` Split perbug-tx into its own package
- #6953 `dfe0d4d` Include perbug-tx binary on Debian/Ubuntu
