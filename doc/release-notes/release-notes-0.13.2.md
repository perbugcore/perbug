Perbug Core version 0.13.2 is now available from:
  ...
  <https://perbug.org/bin/perbug-core-0.13.2/>
...
- #8908 `4a974b2` Update perbug-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow perbug-tx to create v2 transactions (btcdrak)
