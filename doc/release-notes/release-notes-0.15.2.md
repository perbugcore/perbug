Perbug Core version *0.15.2* is now available from:

  <https://perbugcore.org/bin/perbug-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in perbug-tx (TheBlueMatt)
