Perbug Core version 0.16.1 is now available from:

  <https://perbugcore.org/bin/perbug-core-0.16.1/>
...
- #12843 `df38b13` Test starting perbugd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure perbugd processes are cleaned up when tests end (sdaftuar)
