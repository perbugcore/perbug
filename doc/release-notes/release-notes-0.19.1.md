...
Perbug Core version 0.19.1 is now available from:

  <https://perbugcore.org/bin/perbug-core-0.19.1/>
...
From Perbug Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Perbug Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Perbug Core does not yet change appearance when
...
- #17488 fix "perbugd already running" warnings on macOS (fanquake)
