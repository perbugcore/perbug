Perbug version 0.5.4 is now available for download at:
http://sourceforge.net/projects/perbug/files/Perbug/perbug-0.5.4/
...
http://gitorious.org/perbug/perbugd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Perbug-Qt notifications under Growl 1.3.
Increase required age of Perbug-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPerbug properly when installing Perbug-Qt over it. (Windows)
