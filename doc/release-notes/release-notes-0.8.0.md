Perbug-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/perbug/files/Perbug/perbug-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Perbug
...
New/changed settings (command-line or perbug.conf file)
--------------------------------------------------------
