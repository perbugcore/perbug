Perbug Core version 0.9.4 is now available from:

  https://perbug.org/bin/0.9.4/
...
this update is incompatible with the Perbug system and could lead to consensus
forks.

Perbug Core released binaries from https://perbug.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~perbug/+archive/ubuntu/perbug
- A third-party or self-compiled Perbug Core

upgrade to Perbug Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
