Perbug Core version 27.0 is now available from:

  <https://perbugcore.org/bin/perbug-core-27.0/>
...
- libperbugconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libperbugkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Perbug Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Perbug Core would
