...
function(extract_strings output)
  ...
  file(STRINGS "perbugstrings.po" text ENCODING "UTF-8")
...
static const char UNUSED *perbug_strings[] = {
  ...
  set(prefix "QT_TRANSLATE_NOOP(\"perbug-core\", \"")
  set(suffix "\"),\n")
...
extract_strings("${PROJECT_SOURCE_DIR}/src/qt/perbugstrings.cpp"
...
execute_process(
  COMMAND ${LUPDATE_EXECUTABLE}
    ...
    ${PROJECT_SOURCE_DIR}/src/qt/perbugstrings.cpp
    -ts ${PROJECT_SOURCE_DIR}/src/qt/locale/perbug_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)
...
execute_process(
  COMMAND ${LCONVERT_EXECUTABLE}
    -drop-translations
    -o ${PROJECT_SOURCE_DIR}/src/qt/locale/perbug_en.xlf
    -i ${PROJECT_SOURCE_DIR}/src/qt/locale/perbug_en.ts
  COMMAND_ERROR_IS_FATAL ANY
)

file(READ "${PROJECT_SOURCE_DIR}/src/qt/locale/perbug_en.xlf" perbug_en)
string(REPLACE "source-language=\"en\" target-language=\"en\""
  "source-language=\"en\"" perbug_en "${perbug_en}"
)
string(REGEX REPLACE " *<target xml:space=\"preserve\"></target>\n"
  "" perbug_en "${perbug_en}"
)
file(WRITE "${PROJECT_SOURCE_DIR}/src/qt/locale/perbug_en.xlf" "${perbug_en}")
