...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // perbug.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/perbug/perbug/issues/16220 about ways to
        ...
        // Show an error or warn/log if there is a perbug.conf file in the
