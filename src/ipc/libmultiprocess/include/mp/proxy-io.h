...
extern thread_local ThreadContext g_thread_context; // NOLINT(perbug-nontrivial-threadlocal)
// Silence nonstandard perbug tidy error "Variable with non-trivial destructor
