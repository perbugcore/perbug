      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->perbugAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->perbugAtStartup);
    ...
    ui->perbugAtStartup->setToolTip(ui->perbugAtStartup->toolTip().arg(CLIENT_NAME));
    ui->perbugAtStartup->setText(ui->perbugAtStartup->text().arg(CLIENT_NAME));

    ui->openPerbugConfButton->setToolTip(ui->openPerbugConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new PerbugUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->perbugAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPerbugConfButton_clicked()
{
