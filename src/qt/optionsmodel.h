...
/** Interface from Qt to configuration data structure for Perbug client.
...
public:
    ...
    PerbugUnit getDisplayUnit() const { return m_display_perbug_unit; }
...
private:
    ...
    QString language;
    PerbugUnit m_display_perbug_unit;
...
Q_SIGNALS:
    void displayUnitChanged(PerbugUnit unit);
