// Copyright (c) 2011-2022 The Perbug Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <perbug-build-config.h> // IWYU pragma: keep

#include <qt/perbuggui.h>
...
const std::string PerbugGUI::DEFAULT_UIPLATFORM =
...
PerbugGUI::PerbugGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &PerbugGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &PerbugGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &PerbugGUI::showModalOverlay);
...
void PerbugGUI::createActions()
{
    ...
    connect(overviewAction, &QAction::triggered, this, &PerbugGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &PerbugGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &PerbugGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Perbug Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Perbug Transaction from clipboard"));
    ...
    openAction->setStatusTip(tr("Open a perbug: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Perbug command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &PerbugGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &PerbugGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &PerbugGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &PerbugGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &PerbugGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &PerbugGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &PerbugGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &PerbugGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &PerbugGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &PerbugGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &PerbugGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &PerbugGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &PerbugGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &PerbugGUI::showDebugWindow);
}

void PerbugGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void PerbugGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &PerbugGUI::setCurrentWalletBySelectorIndex);
...
void PerbugGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &PerbugGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &PerbugGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &PerbugGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &PerbugGUI::showProgress);
...
#ifdef ENABLE_WALLET
void PerbugGUI::enableHistoryAction(bool privacy)
{
...
void PerbugGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &PerbugGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &PerbugGUI::removeWallet);
...
WalletController* PerbugGUI::getWalletController()
{
    return m_wallet_controller;
}

void PerbugGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &PerbugGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &PerbugGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &PerbugGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &PerbugGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &PerbugGUI::incomingTransaction);
    connect(this, &PerbugGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void PerbugGUI::removeWallet(WalletModel* walletModel)
{
...
void PerbugGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void PerbugGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void PerbugGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void PerbugGUI::setWalletActionsEnabled(bool enabled)
{
...
void PerbugGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &PerbugGUI::toggleHidden);
...
void PerbugGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void PerbugGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void PerbugGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void PerbugGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void PerbugGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void PerbugGUI::openClicked()
{
...
void PerbugGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void PerbugGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void PerbugGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void PerbugGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void PerbugGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void PerbugGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void PerbugGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void PerbugGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Perbug network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void PerbugGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void PerbugGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void PerbugGUI::updateHeadersSyncProgressLabel()
{
...
void PerbugGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void PerbugGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &PerbugGUI::quitRequested);
...
void PerbugGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void PerbugGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &PerbugGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void PerbugGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void PerbugGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &PerbugGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &PerbugGUI::show);
                e->ignore();
            }
        }
    }
...
void PerbugGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void PerbugGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void PerbugGUI::incomingTransaction(const QString& date, PerbugUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(PerbugUnits::formatWithUnit(unit, amount, true));
...
void PerbugGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void PerbugGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool PerbugGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool PerbugGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void PerbugGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void PerbugGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void PerbugGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void PerbugGUI::updateProxyIcon()
{
    std::string ip_port;
...
void PerbugGUI::updateWindowTitle()
{
...
void PerbugGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void PerbugGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void PerbugGUI::detectShutdown()
{
...
void PerbugGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void PerbugGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(PerbugGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = PerbugGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void PerbugGUI::subscribeToCoreSignals()
{
...
void PerbugGUI::unsubscribeFromCoreSignals()
{
...
bool PerbugGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<PerbugUnit> units = PerbugUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const PerbugUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, PerbugUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const PerbugUnit u : PerbugUnits::availableUnits()) {
        menu->addAction(PerbugUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(PerbugUnit newUnits)
{
    setText(PerbugUnits::longName(newUnits));
}
