...
/** Perbug unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PerbugUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PerbugUnits(QObject *parent);

    /** Perbug units.
      @note Source: https://en.perbug.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BTC,
        mBTC,
...
typedef PerbugUnits::Unit PerbugUnit;
