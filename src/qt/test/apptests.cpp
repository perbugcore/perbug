...
//! Entry point for PerbugApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PerbugApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PerbugGUI tests.
void AppTests::guiTests(PerbugGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PerbugGUI::consoleShown, this, &AppTests::consoleTests);
