...
{
    // Test regression https://github.com/perbug/perbug/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/perbug-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/perbug-core/gui/pull/568.
    // With fListen=false in ~/.config/Perbug/Perbug-Qt.conf and all else left as default,
    // perbug-qt should set both -listen and -listenonion to false and start successfully.
