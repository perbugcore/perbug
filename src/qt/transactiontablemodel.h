...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PerbugUnits::SeparatorStyle separators=PerbugUnits::SeparatorStyle::STANDARD) const;
