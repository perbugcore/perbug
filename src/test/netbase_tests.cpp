...
{
    BOOST_CHECK(TestSplitHost("www.perbugcore.org", "www.perbugcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.perbugcore.org]", "www.perbugcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.perbugcore.org:80", "www.perbugcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.perbugcore.org]:80", "www.perbugcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.perbugcore.org:65536", "www.perbugcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.perbugcore.org:0", "www.perbugcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.perbugcore.org:", "www.perbugcore.org:", 0, false));
}
