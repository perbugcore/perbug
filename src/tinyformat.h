...
#include <algorithm>
#include <attributes.h> // Added for Perbug Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Perbug Core
#include <util/string.h> // Added for Perbug Core
...
// Added for Perbug Core. Similar to std::runtime_format from C++26.
...
// Added for Perbug Core. Wrapper for checking format strings at compile time.
