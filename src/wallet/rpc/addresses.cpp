...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{
        ...
        "Returns a new Perbug address for receiving payments.\n"
                ...
                RPCResult{
                    RPCResult::Type::STR, "address", "The new perbug address"
                },
                RPCExamples{
...
RPCHelpMan setlabel()
{
    return RPCHelpMan{
        ...
        "Sets the label associated with the given address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The perbug address to be associated with a label."},
                ...
                RPCResult{
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::ARR, "", "",
                        {
                            ...
                            {
                                {RPCResult::Type::STR, "address", "The perbug address"},
...
RPCHelpMan getaddressinfo()
{
    return RPCHelpMan{
        ...
        "Return information about the given perbug address.\n"
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The perbug address for which to get information."},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        {RPCResult::Type::STR, "address", "The perbug address validated."},
...
RPCHelpMan walletdisplayaddress()
{
    return RPCHelpMan{
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "perbug address to display"},
        },
        RPCResult{
            RPCResult::Type::OBJ,"","",
            {
