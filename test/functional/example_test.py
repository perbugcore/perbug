...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PerbugTestFramework
    pass


class ExampleTest(PerbugTestFramework):
    # Each functional test is a subclass of the PerbugTestFramework class.
    ...
    def custom_method(self):
        ...
        PerbugTestFramework class so other tests can use it."""
