#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Perbug Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting perbug with -h works as expected."""

from test_framework.test_framework import PerbugTestFramework
from test_framework.util import assert_equal

class HelpTest(PerbugTestFramework):
    ...
    def run_test(self):
        self.log.info("Start perbug with -h for help text")
        ...
        self.log.info("Start perbug with -version for version information")
        ...
        self.log.info("Start perbugd with -fakearg to make sure it does not start")
