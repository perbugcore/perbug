#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Perbug Core developers
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"perbug-cli -h\" for help or \"perbug-cli listwallets\" to see "
...
class TestPerbugCli(PerbugTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `perbug-cli getblockchaininfo`")
        ...
        # Prevent perbug-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and perbug-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and perbug-cli getwalletinfo return expected wallet info")
            ...
            # Test perbug-cli -generate with -rpcwallet in multiwallet mode.
