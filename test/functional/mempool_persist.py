...
By default, perbugd will dump mempool on shutdown and
...
class MempoolPersistTest(PerbugTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent perbugd from writing mempool.dat to disk. Verify that `savemempool` fails")
