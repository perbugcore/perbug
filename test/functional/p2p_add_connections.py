#!/usr/bin/env python3
# Copyright (c) 2020-present The Perbug Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The perbugd node closes feeler connections as soon as a version
...
class P2PAddConnections(PerbugTestFramework):
    ...
    def run_test(self):
        ...
        # perbugd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that perbugd sends its own version prior to processing
