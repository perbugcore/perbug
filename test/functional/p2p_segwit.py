...
class SegWitTest(PerbugTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older perbugd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let perbugd fill it in.
