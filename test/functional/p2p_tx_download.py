#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Perbug Core developers
...
class TxDownloadTest(PerbugTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new perbugd instances, as setting mocktimes has long-term effects on when
