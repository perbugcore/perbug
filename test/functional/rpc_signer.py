...
Verify that a perbugd node can use an external signer command.
...
class RPCSignerTest(PerbugTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart perbugd with -signer=<cmd>',
