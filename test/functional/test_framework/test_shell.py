...
class TestShell:
    """Wrapper Class for PerbugTestFramework.

    The TestShell class extends the PerbugTestFramework
    ...
    class __TestShell(PerbugTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PerbugTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # PerbugTestFramework instances are supposed to be constructed with the path
