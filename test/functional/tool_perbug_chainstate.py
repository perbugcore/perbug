...
class PerbugChainstateTest(PerbugTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_perbug_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing perbug-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    PerbugChainstateTest(__file__).main()
