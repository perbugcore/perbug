...
```sh
DOCKER_BUILDKIT=1 docker build -t perbug-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/perbug -it perbug-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/perbug-core/crc32c-subtree.git (branch perbug-fork)
* for `src/crypto/ctaes`: https://github.com/perbug-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/perbug-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/perbug-core/leveldb-subtree.git (branch perbug-fork)
* for `src/minisketch`: https://github.com/perbug-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/perbug-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/perbug-core/secp256k1.git
```
